...
import { userNavigation } from "@/lib/constants";
  ...
  return (
    <>
      <header className={className}>
        <div className="flex h-full items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm 
        sm:gap-x-6 sm:px-6 lg:shadow-none">
          <button
            type="button"
      ...
      <SidebarMobile isOpen={open} set={setOpen} path={path} />
    </>
  );
}
